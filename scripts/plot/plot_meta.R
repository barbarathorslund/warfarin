...
gwas_data_load <- fread("/Users/barbara/Documents/barbara/warfarin/data/meta_sumstats/meta_warf_sumstat_log.txt") %>% 
  janitor::clean_names()
...
## qq
png(file= paste(PLOTS_DIR,"meta_qqplot.png", sep = "/"), width = 6, height = 6, units = "in", res = 1200)
