...
write.table(ukb_merged_pval, "/Users/barbara/Documents/barbara/warfarin/data/ukb/ukb_warf_sumstat_mergedPVAL.txt", col.names = T, row.names = F, quote = F)
write.table(chb_merged_pval, "/Users/barbara/Documents/barbara/warfarin/data/chb/chb_warf_sumstat_mergedPVAL.txt", col.names = T, row.names = F, quote = F)
