...
## Annotate rs numbers
sum_stat <- fread(SUM_STAT_PRE_RSANN)
rsmid <- fread("/Users/barbara/Documents/barbara/warfarin/data/ukb/raw/rsmid_machsvs_mapb37.1000G_p3v5.merged_mach_impute.v3.corrpos.gz")
